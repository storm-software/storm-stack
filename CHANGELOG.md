...
- **monorepo:** Updated the release workflow ([a133826](https://github.com/storm-software/storm-stack/commit/a133826))
...
- **telemetry:** Added the missing `nx-release-publish` value to the `project.json` file ([bd1c793](https://github.com/storm-software/storm-stack/commit/bd1c793))
