...
[Nx](https://build-nx.dev) generators and executors for common development
tasks.
...
This library was generated with [Nx](https://build-nx.dev).
...
Run `build-nx build build-nx-tools` to build the library.

## Running unit tests

Run `build-nx test build-nx-tools` to execute the unit tests via
...
<a href="https://build-nx.dev/" target="_blank">Nx</a>, a set of extensible dev tools
