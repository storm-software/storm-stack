...
[![Version](https://img.shields.io/badge/version-1.2.11-1fb2a6.svg?style=for-the-badge&color=1fb2a6)](https://prettier.io/)&nbsp;
...
This project is
built using [Nx](https://nx.dev). As a result, many of the usual commands are available to assist in development.
