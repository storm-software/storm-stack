...
```bash
pnpm add -D @storm-stack/base-plugin-system
```
...
```bash
npm install -D @storm-stack/base-plugin-system
```
...
```bash
yarn add -D @storm-stack/base-plugin-system
```
...
Run `nx build base-plugin-system` to build the library.

### Running unit tests

Run `nx test base-plugin-system` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint base-plugin-system` to run [ESLint](https://eslint.org/) on the
package.
