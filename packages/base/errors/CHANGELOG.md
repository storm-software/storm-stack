...
- **errors:** Added helper function to `StormError` to quickly create with
  specific types
  ([6ffdb40](https://github.com/storm-software/storm-stack/commit/6ffdb40))
...
- **errors:** Resolved data loss issue when using `Error` object to create a
  `StormError`
  ([5c8f591](https://github.com/storm-software/storm-stack/commit/5c8f591))
...
- **errors:** Resolved issue with incorrect typings
  ([cd93fe2](https://github.com/storm-software/storm-stack/commit/cd93fe2))
...
## [1.13.2](https://github.com/storm-software/storm-stack/compare/errors-v1.13.1...errors-v1.13.2) (2024-01-21)
...
## [1.5.1](https://github.com/storm-software/storm-stack/compare/errors-v1.5.0...errors-v1.5.1) (2023-12-25)
...
## [1.2.8](https://github.com/storm-software/storm-stack/compare/errors-v1.2.7...errors-v1.2.8) (2023-12-12)
