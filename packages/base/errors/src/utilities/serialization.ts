...
import type { JsonObject, JsonValue } from "@storm-stack/serialization/types";
 ...
 */
export function deserializeStormError(
  json: JsonValue
): StormError<string, ErrorType, any> {
  if (isSetObject(json)) {
  ...
  return StormError.createException({
