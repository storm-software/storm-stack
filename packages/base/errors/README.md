...
way to create custom base-errors through error code strings that can be used
...
```bash
pnpm add -D @storm-stack/base-errors
```
...
```bash
npm install -D @storm-stack/base-errors
```
...
```bash
yarn add -D @storm-stack/base-errors
```
