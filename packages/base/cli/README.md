...
```bash
pnpm add -D @storm-stack/base-cli
```
...
```bash
npm install -D @storm-stack/base-cli
```
...
```bash
yarn add -D @storm-stack/base-cli
```
...
Run `nx build base-cli` to build the library.

### Running unit tests

Run `nx test base-cli` to execute the unit tests via [Jest](https://jestjs.io).

### Linting

Run `nx lint base-cli` to run [ESLint](https://eslint.org/) on the package.
...
You can use
[markdownlint-base-cli](https://github.com/storm-software/storm-stack/markdownlint-base-cli)
  ...
  <tfoot>
    <tr>
      <td align="center" size="13px" colspan="7">
        <img src="https://raw.githubusercontent.com/all-contributors/all-contributors-base-cli/1b8533af435da9854653492b1327a23a4dbd0a10/assets/logo-small.svg" alt="All Contributors">
