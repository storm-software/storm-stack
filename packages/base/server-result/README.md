...
```bash
pnpm add -D @storm-stack/base-server-result
```
...
```bash
npm install -D @storm-stack/base-server-result
```
...
```bash
yarn add -D @storm-stack/base-server-result
```
...
Run `nx build base-server-result` to build the library.

### Running unit tests

Run `nx test base-server-result` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint base-server-result` to run [ESLint](https://eslint.org/) on the
package.
