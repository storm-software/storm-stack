...
```bash
pnpm add -D @storm-stack/base-file-system
```
...
```bash
npm install -D @storm-stack/base-file-system
```
...
```bash
yarn add -D @storm-stack/base-file-system
```
...
Run `nx build base-file-system` to build the library.

### Running unit tests

Run `nx test base-file-system` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint base-file-system` to run [ESLint](https://eslint.org/) on the
package.
