...
import type { ClassSerializable } from "./types";
...
export const Serializable = <TData = any>(options?: {
  ...
  >(
    ...
    StormJSON.registerClass(target, identifier);
    return class
      extends target
      implements ClassSerializable<TData>, ClassTypeCheckable<TData>, ITyped
    {
      ...
      public static deserialize = (json: JsonValue) => {
        return StormJSON.serialize(json);
      };
      ...
      public static parse = (strObject: string): TData => {
        return StormJSON.parse(strObject);
      };
      ...
      public serialize = (): JsonParserResult => {
        return StormJSON.serialize(this);
      };
      ...
      public stringify = (): string => {
        return StormJSON.stringify(this);
      };
