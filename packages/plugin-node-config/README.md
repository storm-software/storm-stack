...
A package containing a Storm Stack base plugin for managing application configuration.
...
```bash
pnpm add @storm-stack/plugin-crypto
```
...
```bash
npm install @storm-stack/plugin-crypto
```
...
```bash
yarn add @storm-stack/plugin-crypto
```
