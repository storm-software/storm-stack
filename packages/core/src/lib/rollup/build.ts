...
import { RollupOptions } from "../../types/config";
import { Context } from "../../types/context";
import { resolveRollupOptions } from "./options";

/**
 * Build the project using [rollup](https://rollupjs.org/)
 *
...
export async function rollup(
  ...
  await build({
    ...resolveRollupOptions(context, options),
