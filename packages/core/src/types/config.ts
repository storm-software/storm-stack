...
export interface ProjectConfig {
  ...
  /**
   * The path (relative to the project root) to the file that will be used to generate the types map
   *
   * @remarks
   * This file will be generated by the prepare process (if it doesn't already exist) and will contain list of runtime type definitions that can be used in the application.
   *
