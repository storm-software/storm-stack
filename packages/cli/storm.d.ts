...
declare module "storm:config" {
  ...
  export interface StormConfigBase extends StormConfigInterface {
     ...
     * @defaultValue ccbc70d5-3a05-4e8a-b423-ef4134a0196a
     */
    BUILD_ID: string;
    /**
     * Build Timestamp
     ...
     * @defaultValue 2025-08-19T09:08:10.159Z
     */
    BUILD_TIMESTAMP: string;
    /**
     * Builder Output
    ...
    */
     ...
     * @defaultValue bc70d53a-05be-4af4-a3ef-4134a0196a6c
     */
    RELEASE_ID: string;
    /**
     * Release Tag
     *
     * @title Release Tag
     * @defaultValue storm-stack@0.15.0
     */
    RELEASE_TAG: string;
    /**
     * Render
