...
declare module "storm:config" {
  ...
  export interface StormConfigBase extends StormConfigInterface {
     ...
     * @defaultValue ecb8f747-fc92-4125-81e3-b362dc7853d4
     */
    BUILD_ID: string;
    /**
     * Build Timestamp
     ...
     * @defaultValue 2025-08-17T05:33:35.764Z
     */
    BUILD_TIMESTAMP: string;
    /**
     * Builder Output
     ...
     * @title Config
     * @domain cli
     * @defaultValue {"$schema":"https://public.storm-cdn.com/schemas/storm-workspace.schema.json","name":"storm-stack","namespace":"storm-stack","organization":{"name":"storm-software","description":"An open source software development organization and the creator of the Stryke utilities, Storm Stack, Cyclone UI, Acidic, and Storm Cloud.","logo":"https://public.storm-cdn.com/logo.png","icon":"https://public.storm-cdn.com/icon-fill.png","url":"https://stormsoftware.com"},"repository":"https://github.com/storm-software/storm-stack","license":"Apache-2.0","homepage":"https://stormsoftware.com","docs":"https://docs.stormsoftware.com/projects/storm-stack","portal":"https://developer.stormsoftware.com","licensing":"https://stormsoftware.com/licenses","contact":"https://stormsoftware.com/contact","support":"https://stormsoftware.com/support","branch":"main","owner":"@storm-software/admin","bot":{"name":"stormie-bot","email":"bot@stormsoftware.com"},"release":{"banner":{"url":"https://public.storm-cdn.com/brand-banner.png","alt":"Storm Software's logo banner"},"footer":"Storm Software is an open source software development organization with the mission is to make software development more accessible. Our ideal future is one where anyone can create software without years of prior development experience serving as a barrier to entry. We hope to achieve this via LLMs, Generative AI, and intuitive, high-level data modeling/programming languages.\n\nJoin us on [Discord](https://discord.gg/MQ6YVzakM5) to chat with the team, receive release notifications, ask questions, and get involved.\n\nIf this sounds interesting, and you would like to help us in creating the next generation of development tools, please reach out on our [website](https://stormsoftware.com/contact) or join our [Slack](https://join.slack.com/t/storm-software/shared_invite/zt-2gsmk04hs-i6yhK_r6urq0dkZYAwq2pA) channel!"},"socials":{"twitter":"StormSoftwareHQ","discord":"https://discord.gg/MQ6YVzakM5","telegram":"https://t.me/storm_software","slack":"https://join.slack.com/t/storm-software/shared_invite/zt-2gsmk04hs-i6yhK_r6urq0dkZYAwq2pA","medium":"https://medium.com/storm-software","github":"https://github.com/storm-software"},"error":{"codesFile":"tools/errors/codes.json","url":"https://developer.stormsoftware.com/static/errors"},"mode":"production","workspaceRoot":"/home/development/repos/storm-stack","skipCache":false,"directories":{"build":"dist"},"packageManager":"pnpm","timezone":"America/New_York","locale":"en-US","logLevel":"debug","skipConfigLogging":true,"registry":{"github":"https://npm.pkg.github.com","npm":"https://registry.npmjs.org","cargo":"https://crates.io","cyclone":"https://registry.cyclone-ui.com/components","container":"https://hub.docker.com"},"configFile":"storm-workspace.config","colors":{"dark":{"foreground":"#cbd5e1","background":"#151718","brand":"#1fb2a6","alternate":"#db2777","link":"#3fa6ff","help":"#818cf8","success":"#45b27e","info":"#38bdf8","warning":"#f3d371","danger":"#d8314a","fatal":"#7d1a1a","positive":"#22c55e","negative":"#dc2626","gradient":["#1fb2a6","#db2777","#818cf8"]},"light":{"foreground":"#1d1e22","background":"#fafafa","brand":"#1fb2a6","alternate":"#db2777","link":"#3fa6ff","help":"#5c4ee5","success":"#087f5b","info":"#0550ae","warning":"#e3b341","danger":"#a40e26","fatal":"#51070f","positive":"#22c55e","negative":"#dc2626","gradient":["#1fb2a6","#db2777","#5c4ee5"]}},"extensions":{}}
     */
    CONFIG?: string | true;
    /**
    ...
    */
     ...
     * @defaultValue b8f747fc-9251-4541-a3b3-62dc7853d444
     */
    RELEASE_ID: string;
    /**
     * Release Tag
     *
     * @title Release Tag
     * @defaultValue storm-stack@0.14.1
     */
    RELEASE_TAG: string;
    /**
     * Render
...
declare module "storm:context" {
  ...
  export type StormContext = StormContextInterface<
    ...
    StormEnvInterface
  >;
  export const STORM_ASYNC_CONTEXT: UseContext<StormContext>;
  /**
...
declare module "storm:cli" {
  ...
  export const AnsiLevelMapping: string[];
  /**
  ...
  export {};
  export type __ΩCLIBasePayloadData = any[];
...
declare module "storm:app" {
  ...
  export function createCLI<
    TInput extends CLIBasePayloadData = CLIBasePayloadData,
    TOutput = any
  >(
    handler: HandlerFunction<TInput, TOutput>
