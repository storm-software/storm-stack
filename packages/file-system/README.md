...
[![Version](https://img.shields.io/badge/version-1.21.3-1fb2a6.svg?style=for-the-badge&color=1fb2a6)](https://prettier.io/)&nbsp;
...
A utility package containing various methods used to manipulate files
...
```bash
pnpm add -D @storm-stack/file-system
```
...
```bash
npm install -D @storm-stack/file-system
```
...
```bash
yarn add -D @storm-stack/file-system
```
...
Run `nx test file-system` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint file-system` to run [ESLint](https://eslint.org/) on the package.
