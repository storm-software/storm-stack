...
[![Version](https://img.shields.io/badge/version-1.10.1-1fb2a6.svg?style=for-the-badge&color=1fb2a6)](https://prettier.io/)&nbsp;
...
```bash
npm install -D @storm-stack/jotai
```
...
Run `nx lint jotai` to run [ESLint](https://eslint.org/) on the package.
