...
```bash
npm install -D @storm-stack/utils-file-system
```
...
Run `nx build utils-file-system` to build the library.

### Running unit tests

Run `nx test utils-file-system` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint utils-file-system` to run [ESLint](https://eslint.org/) on the
package.
