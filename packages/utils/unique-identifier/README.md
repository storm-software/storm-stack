...
```bash
pnpm add -D @storm-stack/utils-unique-identifier
```
...
```bash
npm install -D @storm-stack/utils-unique-identifier
```
...
```bash
yarn add -D @storm-stack/utils-unique-identifier
```
...
Run `nx build utils-unique-identifier` to build the library.

### Running unit tests

Run `nx test utils-unique-identifier` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint utils-unique-identifier` to run [ESLint](https://eslint.org/) on
the package.
