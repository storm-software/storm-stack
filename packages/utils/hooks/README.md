...
```bash
pnpm add -D @storm-stack/utils-hooks
```
...
```bash
npm install -D @storm-stack/utils-hooks
```
...
```bash
yarn add -D @storm-stack/utils-hooks
```
...
Run `nx build utils-hooks` to build the library.

### Running unit tests

Run `nx test utils-hooks` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint utils-hooks` to run [ESLint](https://eslint.org/) on the package.
