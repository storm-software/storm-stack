...
# Storm Stack - TypeScript Types

A package containing shared TypeScript type definitions used in Storm Stack
projects.
...
- [Storm Stack - TypeScript Types](#storm-stack---typescript-types)
...
```bash
npm install -D @storm-stack/types
```
