...
A package containing the Storm Stack NodeJs plugin used to add basic functionality to the Storm Stack runtime.
...
- [Storm Stack - NodeJs Plugin](#storm-stack---nodejs-plugin)
...
```bash
pnpm add @storm-stack/plugin-log-console
```
...
```bash
npm install @storm-stack/plugin-log-console
```
...
```bash
yarn add @storm-stack/plugin-log-console
```
...
Run `nx build @storm-stack/plugin-log-console` to build the library.

### Running unit tests

Run `nx test @storm-stack/plugin-log-console` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint @storm-stack/plugin-log-console` to run
