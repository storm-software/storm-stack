...
type CleanupFunction = () => MaybePromise<
  IStormError | void | null | undefined
>;

type DeserializerFunction<TPayload extends IStormPayload, TInput = any> = (
  input: TInput
) => MaybePromise<TPayload | IStormError>;
...
type SerializerFunction<TResult extends IStormResult, TOutput = any> = (
...
interface StormVariables extends StormBaseVariables {
  /**
   * The appcircle build ID. This value is set by certain CI/CD systems.
   *
   * @title Ac Appcircle
...
declare module "storm:env" {
  ...
  export const stormVariablesNamingStrategy: {
    getPropertyName(
  ...
  export const vars: StormVariables;
}
...
declare module "storm:logs/sentry-info" {
  declare const sink: (record: LogRecord) => void;
  export default sink;
}
