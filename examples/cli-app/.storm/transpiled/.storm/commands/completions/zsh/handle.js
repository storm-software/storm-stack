...
// examples/cli-app/.storm/commands/completions/zsh/handle.ts
...
var __\u03A9CompletionsZshPayload = [true, "script", "The path to write the completion script to.", true, "config", "The configuration file to append the completion script to.", "CompletionsZshPayload", `PP&.!J4"8?#P&.$J4%8?&Mw'y`];
...
`);
  ...
  if (payload.data.config) {
    let configFile = payload.data.config === true ? "~/.zshrc" : payload.data.config;
    ...
    const scriptFile = typeof payload.data.script === "string" ? payload.data.script : "examples-cli-completions.zsh";
...
handler.__type = [() => __\u03A9CompletionsZshPayload, () => StormPayload, "payload", "handler", "Generates a Zsh shell completion script for the Examples CLI App CLI application.", 'PPn!7"2#"/$?%'];
var handle_default = handler;
export {
  __\u03A9CompletionsZshPayload,
