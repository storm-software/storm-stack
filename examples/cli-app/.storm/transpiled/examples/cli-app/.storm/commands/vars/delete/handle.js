...
handler.__type = [() => __\u03A9VarsDeletePayload, () => StormPayload, "payload", "handler", "Deletes a configuration parameter from the variables store.", 'PPn!7"2#"/$?%'];
var handle_default = handler;
export {
  __\u03A9VarsDeletePayload,
