...
/**
 * Renders the CLI Completions - Zsh Shell command usage information.
 *
...
export function renderUsage(mode: "full" | "minimal" = "full"): string {
  return `${colors.whiteBright(colors.bold(`CLI Completions - Zsh Shell${mode === "minimal" ? " Command" : ""}`))}

  ${colors.gray("Generates a Zsh shell completion script for the Examples CLI App CLI application.")}
