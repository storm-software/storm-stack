...
declare module "storm:config" {
  ...
  export interface StormConfigBase extends StormConfigInterface {
     ...
     *
     * @title App Name
     * @defaultValue examples-cloudflare-worker
     */
    APP_NAME: string;
    /**
     * App Version
     ...
     * @defaultValue 285dee6f-84be-4c29-a0c1-85f14da1c8bc
     */
    BUILD_ID: string;
    /**
     * Build Timestamp
     ...
     * @defaultValue 2025-08-17T05:34:16.951Z
     */
    BUILD_TIMESTAMP: string;
    /**
     * Builder Output
     ...
     * @defaultValue 5dee6f84-be6c-49e0-8185-f14da1c8bcf7
     */
    RELEASE_ID: string;
    /**
     * Release Tag
     *
     * @title Release Tag
     * @defaultValue examples-cloudflare-worker@0.0.1
     */
    RELEASE_TAG: string;
    /**
     * Render
  ...
  /**
   * The initial configuration state for the Examples Cloudflare Worker project..
   */
